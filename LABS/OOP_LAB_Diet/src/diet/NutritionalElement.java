...
public interface NutritionalElement {
	...
	public default double getCalories(double quantity) {
	...
	public default double getProteins(double quantity) {
	...
	public default double getCarbs(double quantity) {
	...
	public default double getFat(double quantity) {
