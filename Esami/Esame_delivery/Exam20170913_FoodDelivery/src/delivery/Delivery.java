...
//    	Map<Double,List<Customer>> customerM= 
//    			                                 customers.values().stream()
//        		                                 .sorted(Comparator.comparing(Customer :: totalCustomer).reversed())
//								                 .collect(Collectors.groupingBy(Customer :: totalCustomer, TreeMap :: new, LinkedList :: new );
			return null;					                	
