...
public class Quiz {
	...
	public static int[] answer(int question){
		...
		switch(question){
			case 0: return new int[]{1,2,3}; // replace with your answers
			case 1: return new int[] {1,2}; // replace with your answers
			case 2: return new int[] {0,3}; // replace with your answers
		}
